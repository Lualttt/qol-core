...
namespace qol_core
{
    ...
    public class Plugin : BasePlugin
    {
        ...
        public static void ClearChatbox(ChatBox chat) {
            chat.Method_Private_Void_2();// ClearMessage
            chat.prop_Boolean_0 = false; // typing
            chat.inputField.DeactivateInputField();

            // theres a method for this but its hidden in about 50 junk methods generated by the obfuscator so
            chat.overlay.CrossFadeAlpha(0f, 1f, true);
            chat.messages.CrossFadeAlpha(0f, 1f, true);
            chat.inputField.GetComponent<UnityEngine.UI.Image>().CrossFadeAlpha(0f, 1f, true);
            chat.inputField.GetComponentInChildren<TMPro.TextMeshProUGUI>().CrossFadeAlpha(0f, 1f, true);
        }
